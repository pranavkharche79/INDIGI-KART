        ...
        <div className="container-fluid text-white">
                ...
                <tbody>
                    {state.cart.map(item=>(
                        <tr key={item.prodid}>
                            <td>{item.prodid}</td>
                            <td>
                                <img className="mr-2 float-left" src={item.photo} alt="Not loded" width="100" />
                                {item.pname}
                            </td>
                            <td>&#8377; {item.price}</td>
                            <td>{item.qty}</td>
            ...
            <form onSubmit={handleSubmit} >           
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="number" name="zip" required value={address.zip} onChange={handleAddressInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
                    <label className="col-sm-4 form-control-label">Country</label>
                    <div className="col-sm-8">
                        <input type="text" name="country" readOnly value={address.country} onChange={handleAddressInput} className="form-control" />                       
                    </div>                        
                </div>
                ...
                <div className="form-group form-row">
                    ...
                    <div className="col-sm-8">
                        <input type="text" pattern="[0-9]{3,4}" placeholder="Enter CVV" maxLength="4" name="cvv" required value={payment.cvv} onChange={handlePaymentInput} className="form-control" />                        
                    </div>                        
                </div>
                <div className="form-group form-row">
