                    ...
                    <div className="row">
                        <div className="col-sm-6 mx-auto">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="file" required name="photo" accept=".jpg,.png" onChange={(e) => ( setImage(e.target.files[0]))} className="form-control-file" />                                    
                                </div>                                
                            </div>
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="number" name="price" value={product.price} required onChange={handleInput} className="form-control" />
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input name="descr" value={product.descr} required onChange={handleInput} className="form-control"/>  
